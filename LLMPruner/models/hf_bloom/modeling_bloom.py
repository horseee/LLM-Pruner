...
class BloomModel(BloomPreTrainedModel):
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        #alibi = self.build_alibi_tensor(attention_mask, self.num_heads, dtype=hidden_states.dtype) # LLM-Pruner: Delete this line and move it to the loop below
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            alibi = self.build_alibi_tensor(attention_mask, block.self_attention.num_heads, dtype=hidden_states.dtype) # LLM-Pruner: Move the alibi here since each layer has different num_heads
