...
class GemmaRMSNormPrunner(BasePruningFunc):
...
gemma_rmsnorm_pruner = GemmaRMSNormPrunner()
    ...
    def __call__(self, group, ch_groups=1, consecutive_groups=1):
        ...
        for dep, idxs in group:
            ...
            # Linear in_channels
                ...
                group_imp.append(local_norm)
            # RMSNorm
            elif prune_fn == gemma_rmsnorm_pruner.prune_out_channels:
                # regularize BN
    ...
    def __call__(self, group, ch_groups=1, consecutive_groups=1):
        ...
        for dep, idxs in group:
            ...
            if prune_fn not in [
                ...
                gemma_rmsnorm_pruner.prune_out_channels, tp.prune_embedding_out_channels, hf_attention_pruner.prune_out_channels,
